...
const Registrar = () => {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            setAlerta({
                msg: 'Creado exitosamente, revisa tu email',
                error: false
            })
        } catch (error) {
            setAlerta({
  ...
  return (
    <>
        ...
        <div>
            <h1 className='text-fuchsia-900 font-black text-6xl'>Crea tu Cuenta y Administra {""} <span className='text-emerald-600'>Tus Pacientes</span></h1>
        </div>
